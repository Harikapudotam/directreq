...
//   Action     : 'MyService.EntityContainer/triggerIFlow',
//   Label      : 'Send for iflow',
//   Criticality: #Neutral
// },
        {
            $Type : 'UI.DataField',
...
annotate service.RequestHeaders { 
 ...
 Label : '', 
Parameters : [ 
{$Type: 'Common.ValueListParameterInOut', LocalDataProperty: reqdesc, ValueListProperty: 'reqdesc'}, 
...
annotate service.RequestItems {
    material @(
        Common.ValueList:{
            ...
            Label : '',
            Parameters:[
                {$Type : 'Common.ValueListParameterInOut',LocalDataProperty :'material_MID' ,ValueListProperty :'MID'},
            ]
        },
...
annotate service.RequestItems {
    plant @(
        Common.ValueList:{
            ...
            Label : '',
            Parameters:[
                {$Type : 'Common.ValueListParameterInOut',LocalDataProperty :'plant_Product' ,ValueListProperty :'Product'},
            ]
        },
